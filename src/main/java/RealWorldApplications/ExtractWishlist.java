...
public class ExtractWishlist {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        ExtractWishlist ew = new ExtractWishlist();
        int ch;
        ...
        List<WebElement> priceElement = driver.findElements(By.cssSelector("li[data-id='H15GSZNFJH64']"));
        ...
        for (int i = 1, j = 0; i <= listSize; i += 2, j++) {
            ...
            newData[j][0] = String.valueOf(j);
            newData[j][1] = bookListTitle.get(i).getAttribute("title");
            newData[j][2] = bookListTitle.get(i).getAttribute("title");
            newData[j][3] = "₹ " + price;
            ...
            newData[j][2] = driver.getCurrentUrl();
